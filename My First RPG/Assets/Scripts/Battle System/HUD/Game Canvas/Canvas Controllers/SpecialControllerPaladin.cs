...
public class SpecialControllerPaladin : MonoBehaviour
{
    ...
    public GameObject paladinPointerGO;
    ...
    public bool massAttack;
    public bool hyperAttack;

    public bool partySpell;
    ...
    public void OnCancelSpecial()
    {
        ...
        clickController.paladinIsUsingSpecial = false;
    }
